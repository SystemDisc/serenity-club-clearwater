      ...
      <section className="bg-white px-4 py-16">
        <div className="container grid gap-5 md:grid-cols-3">
          <article className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <ButtonLink className="mt-5" href={data.settings.donationUrl} variant="primary">
              Donate online
            </ButtonLink>
          </article>
          <article className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <ButtonLink className="mt-5" href="/shop" variant="secondary">
              View memberships
            </ButtonLink>
          </article>
          <article className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <ButtonLink className="mt-5" href="/reach-out" variant="secondary">
              Reach out
            </ButtonLink>
          </article>
        </div>
