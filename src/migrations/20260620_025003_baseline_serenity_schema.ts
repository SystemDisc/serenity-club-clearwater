...
export async function up({ db, payload: _payload, req: _req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_meetings_fellowship" AS ENUM('AA', 'NA', 'Club');
  CREATE TYPE "public"."enum_meetings_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__meetings_v_version_fellowship" AS ENUM('AA', 'NA', 'Club');
  CREATE TYPE "public"."enum__meetings_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_events_category" AS ENUM('Fundraiser', 'Meeting', 'Service', 'Community');
  CREATE TYPE "public"."enum_events_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__events_v_version_category" AS ENUM('Fundraiser', 'Meeting', 'Service', 'Community');
  CREATE TYPE "public"."enum__events_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_gallery_items_category" AS ENUM('Clubhouse', 'Event', 'People', 'Flyer', 'Community');
  CREATE TYPE "public"."enum_gallery_items_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__gallery_items_v_version_category" AS ENUM('Clubhouse', 'Event', 'People', 'Flyer', 'Community');
  ...
  CREATE TABLE "meetings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"name" varchar,
  	"fellowship" "enum_meetings_fellowship",
  	"time" varchar,
  	"days" varchar,
  	"room" varchar,
  	"format" varchar,
  	...
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"_status" "enum_meetings_status" DEFAULT 'draft'
  );
  
  CREATE TABLE "_meetings_v" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"parent_id" integer,
  	"version_name" varchar,
  	"version_fellowship" "enum__meetings_v_version_fellowship",
  	"version_time" varchar,
  	"version_days" varchar,
  	...
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  	"version__status" "enum__meetings_v_version_status" DEFAULT 'draft',
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"latest" boolean
  );
  ...
  CREATE TABLE "events" (
  	...
  	"date_label" varchar,
  	"time_label" varchar,
  	"category" "enum_events_category" DEFAULT 'Community',
  	"summary" varchar,
  	"image_id" integer,
  ...
  CREATE TABLE "_events_v" (
  	...
  	"version_category" "enum__events_v_version_category" DEFAULT 'Community',
  ...
  CREATE TABLE "gallery_items" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar,
  	"category" "enum_gallery_items_category" DEFAULT 'Clubhouse',
  	"description" varchar,
  	"image_id" integer,
  	"external_image_url" varchar,
  	"image_alt" varchar,
  ...
  CREATE TABLE "_gallery_items_v" (
  	...
  	"parent_id" integer,
  	"version_title" varchar,
  	"version_category" "enum__gallery_items_v_version_category" DEFAULT 'Clubhouse',
  	"version_description" varchar,
  	"version_image_id" integer,
  	"version_external_image_url" varchar,
  	"version_image_alt" varchar,
  ...
  CREATE TABLE "_products_v" (
  	...
  	"version_external_image_url" varchar,
  	"version_image_alt" varchar,
  	"version_checkout_url" varchar,
  	"version_fulfillment_note" varchar,
  	"version_order" numeric DEFAULT 100,
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  ...
  CREATE TABLE "club_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"name" varchar DEFAULT 'Serenity Club of Clearwater' NOT NULL,
  	"legal_name" varchar DEFAULT 'Serenity Club of Clearwater, Inc.',
  	"tagline" varchar DEFAULT 'A safe, supportive and empowering home for the local recovery community.',
  	"summary" varchar,
  	"address" varchar DEFAULT '631 Turner Street',
  ...
  ALTER TABLE "_meetings_v" ADD CONSTRAINT "_meetings_v_parent_id_meetings_id_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."meetings"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_sponsors_v" ADD CONSTRAINT "_sponsors_v_version_image_id_media_id_fk" FOREIGN KEY ("version_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "club_settings" ADD CONSTRAINT "club_settings_hero_image_id_media_id_fk" FOREIGN KEY ("hero_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "club_settings" ADD CONSTRAINT "club_settings_room_image_id_media_id_fk" FOREIGN KEY ("room_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "club_settings" ADD CONSTRAINT "club_settings_logo_image_id_media_id_fk" FOREIGN KEY ("logo_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "meetings__status_idx" ON "meetings" USING btree ("_status");
  CREATE INDEX "_meetings_v_parent_idx" ON "_meetings_v" USING btree ("parent_id");
  CREATE INDEX "_meetings_v_version_version_updated_at_idx" ON "_meetings_v" USING btree ("version_updated_at");
  CREATE INDEX "_meetings_v_version_version_created_at_idx" ON "_meetings_v" USING btree ("version_created_at");
  CREATE INDEX "_meetings_v_version_version__status_idx" ON "_meetings_v" USING btree ("version__status");
  CREATE INDEX "_meetings_v_created_at_idx" ON "_meetings_v" USING btree ("created_at");
  CREATE INDEX "_meetings_v_updated_at_idx" ON "_meetings_v" USING btree ("updated_at");
  CREATE INDEX "_meetings_v_latest_idx" ON "_meetings_v" USING btree ("latest");
  ...
  CREATE INDEX "sponsors_image_idx" ON "sponsors" USING btree ("image_id");
  ...
  CREATE INDEX "_sponsors_v_version_version_image_idx" ON "_sponsors_v" USING btree ("version_image_id");
  ...
  CREATE INDEX "club_settings_hero_image_idx" ON "club_settings" USING btree ("hero_image_id");
  CREATE INDEX "club_settings_room_image_idx" ON "club_settings" USING btree ("room_image_id");
  CREATE INDEX "club_settings_logo_image_idx" ON "club_settings" USING btree ("logo_image_id");
...
export async function down({ db, payload: _payload, req: _req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "_meetings_v" CASCADE;
  ...
  DROP TABLE "club_settings" CASCADE;
  ...
  DROP TYPE "public"."enum_meetings_fellowship";
  DROP TYPE "public"."enum_meetings_status";
  DROP TYPE "public"."enum__meetings_v_version_fellowship";
  DROP TYPE "public"."enum__meetings_v_version_status";
